...
app.include_router(auth_router); app.include_router(listings_router); app.include_router(internal_router); app.include_router(alerts_router); app.include_router(web_router)
@app.get("/health")
