...
def test_import_and_disabled_handler_do_not_construct_repository_or_job(monkeypatch):
 ...
 monkeypatch.setattr(module,"create_ads_repository",lambda **kwargs:calls.append("repository"));monkeypatch.setattr(module,"run_scheduled_ads_historical_sync",lambda:calls.append("job"))
